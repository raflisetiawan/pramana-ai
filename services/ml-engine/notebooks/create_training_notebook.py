"""
Script to generate the training notebook for Pramana AI ML Engine.
Run: python services/ml-engine/notebooks/create_training_notebook.py
"""
import json
...
def code(lines): return {"cell_type": "code", "metadata": {}, "source": lines, "execution_count": None, "outputs": []}
...
cells = [
    ...
    md(["## 5. Ensemble: Weighted Average RF + XGBoost"]),
    code([
...
output = Path(__file__).parent / "02_training.ipynb"
